      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">IT - VDTexpress</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="card">
            <div class="card-header d-flex p-0">
              <h3 class="card-title p-3">
                <i class="fa fa-pie-chart mr-1"></i> Số liệu lượng đơn hàng
              </h3>
          ...
          <div class="card direct-chat direct-chat-primary">
            <div class="card-header">
              <h3 class="card-title">Trao đổi trực tuyến</h3>
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  <div class="direct-chat-info clearfix">
                    <span class="direct-chat-name float-left">Đỗ Huy</span>
                ...
                <div class="direct-chat-msg right">
                  <div class="direct-chat-info clearfix">
                    <span class="direct-chat-name float-right">Lê Sơn Lâm</span>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                <i class="ion ion-clipboard mr-1"></i> Nhắc nhở hàng ngày
              </h3>
            ...
            <div class="card-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Chiều giao hàng cho Đăng gara</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Chiều lấy hàng cho Liên Ruby</span>
            ...
            <div class="card-footer clearfix">
              <button type="button" class="btn btn-info float-right"><i class="fa fa-plus"></i> Thêm nhắc nhở</button>
            </div>
          </div>
          <!-- /.card -->
        </section>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="card bg-primary-gradient">
            <div class="card-header no-border">
              <h3 class="card-title">
                <i class="fa fa-map-marker mr-1"></i> Sài Gòn - Long An
              </h3>
              <!-- card tools -->
              <div class="card-tools">
            ...
            <div class="card-footer bg-transparent">
              <div class="row">
                <div class="col-4 text-center">
                  ...
                  <div class="text-white">Sài Gòn - Long An</div>
                </div>
                <!-- ./col -->
                <div class="col-4 text-center">
